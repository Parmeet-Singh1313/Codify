...
// This hook is used to hide the sidebar and other components when the keyboard is open on mobile devices and to adjust the height of the sidebar views and editor
