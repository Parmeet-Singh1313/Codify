...
function SettingContextProvider({ children }) {
    ...
    const storedShowGitHubCorner = storedSettings.showGitHubCorner !== undefined ? storedSettings.showGitHubCorner : defaultSettings.showGitHubCorner;
    ...
    const [showGitHubCorner, setShowGitHubCorner] = useState(storedShowGitHubCorner);
